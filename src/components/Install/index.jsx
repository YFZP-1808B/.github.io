...
<p>3:进入项目:npm start 直接运行开发环境 不需要我们在手动安装 node-module依赖,脚手架已经为我们安装好了</p>
<p>npm run eject 可以解决哪些问题</p>
<p>本地项目里的依赖和全局依赖包版本不一致导致的bug 可以使用此命令解决</p>
<p>注意:如果咱们的项目初始化的时候就是在git仓库里面的,那么我们在使用此命令的时候就会失败,控制台就会提示我们应该先储存代码到本地git仓库</p>
